...
export const useProductStore = create((set) => ({
  product: {
    ...
    setHeroImageSrc: (heroImageSrc) => set((state)=>({...state, product:{...state.product, heroImageSrc:heroImageSrc}})),
    colors: [
      { name: "White", code: "#FFFFFF", src: "/products/product-detail-img-1.jpg" },
      { name: "Black", code: "#000000", src: "/products/product-detail-img-1.jpg" },
      { name: "Gray", code: "#808080", src: "/products/product-detail-img-1.jpg" },
    ],
    mainColor: { name: "White", code: "#FFFFFF", src: "/products/product-detail-img-1.jpg" },
    setMainColor: (mainColor) => set(state => ({...state, product:{...state.product, mainColor}})), 
    sizes: [
    ...
    choosenSize: {},
    setChoosenSize: (choosenSize) => set(state => ({...state, product:{...state.product, choosenSize}})) ,
