...
function Navbar() {
  ...
  return (
    <div className="nav-bar flex flex-wrap justify-between mt-2 border-b pb-2 px-10">
      ...
      <div className="middle flex gap-0 bg-transparent relative">
        ...
        <Input
          className="border border-black rounded-none md:pl-16 bg-transparent font-medium text-black w-32 md:w-full"
        ...
        <div className="avatar flex gap-2 items-center">
          <DropdownMenu>
            ...
            <DropdownMenuContent className="md:hidden">
              <DropdownMenuItem>
                <span className="heart text-md font-medium flex gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <DropdownMenuItem>
                <span className="notification text-md font-medium flex gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <DropdownMenuItem>
                <span className="shopping-cart text-md font-medium flex gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
